...
import { deleteRecurringEvent } from 'service/api';



function DeleteRecurringEvent({ isOpen, onRequestClose ,eventId}) {
...
const vid=localStorage.getItem('Venue')
    ...
    const req = { 
      data:{id:eventId ,venue_id:vid,type:"recurring"}
    };
  
    await deleteRecurringEvent(req)
      .then((res) => {
